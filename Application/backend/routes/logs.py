"""
Logs Routes
    - GET /api/logs - Retrieves analysis logs from MongoDB
    - GET /api/logs/<id> - Retrieves a single log by ID
    - GET /api/simulations - Retrieves simulation session summaries
"""
